...
//****************************************************************************************
#define TWI_PORT					PORTC	// ѕорт где сидит нога TWI
#define TWI_DDR						DDRC
#define TWI_SCL						0	 // Ѕиты соответствующих выводов
#define TWI_SDA						1
...
#define TWI_STX_DATA_ACK_LAST_BYTE 0xC8  // Last data byte in TWDR has been transmitted (TWEA = У0Ф); ACK has been received
