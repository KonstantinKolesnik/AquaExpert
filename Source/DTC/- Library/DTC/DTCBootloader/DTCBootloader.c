...
#include "DTCBootloader.h"


#define DTCBOOTLOADER_MAJVER 1
#define DTCBOOTLOADER_MINVER 1

#define DTCBOOTLOADER_VERSION (DTCBOOTLOADER_MINVER * 256 + DTCBOOTLOADER_MAJVER)
