...
[assembly: MigrationAssembly("SmartHub.Plugins.Weather")]
...
namespace SmartHub.Plugins.Weather.Data
{
    ...
    public class Migration01 : Migration
    {
        public override void Apply()
        {
            ...
            Database.AddUniqueConstraint("UK_Weather_Data_LocationId_Date", "Weather_Data", "LocationId", "Date");
            Database.AddForeignKey("FK_Weather_Data_LocationId",
                "Weather_Data", "LocationId",
                "Weather_Location", "Id", ForeignKeyConstraint.Cascade);
        }
