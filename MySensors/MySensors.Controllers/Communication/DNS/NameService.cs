...
namespace MySensors.Controllers.Communication.DNS
{
    // Usage example
    ...
    public class NameService : IDisposable
    {
        ...
        public NameService()
        {
            ...
            foreach (NetworkInterface nic in NetworkInterface.GetAllNetworkInterfaces())
                ...
                {
                    localMacAddress = nic.GetPhysicalAddress().GetAddressBytes();
                    break;
                }
            ...
            updateTimer = new Timer(new TimerCallback(OnUpdate), null, Timeout.Infinite, Timeout.Infinite);
